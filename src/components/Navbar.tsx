...
import { Home, Book, Gavel, HelpCircle, FileText, MessageSquare, Users, Inbox, Info, Phone, LogIn } from 'lucide-react';
  ...
  return (
    <nav className="bg-white shadow-lg border-b border-primary-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 space-x-reverse">
            ...
            <div className="flex flex-col">
              <span className="text-primary-900 font-bold text-lg">الموسوعة القانونية</span>
              <span className="text-primary-600 text-sm">الجزائرية الذكية</span>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-4 space-x-reverse">
            {user ? (
              ...
              <Link
                to="/auth"
                className="flex items-center space-x-2 space-x-reverse bg-primary-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-primary-700 transition-colors"
              >
            ...
            <button
              ...
              className="lg:hidden p-2 rounded-md text-gray-700 hover:text-primary-700 hover:bg-primary-50 transition-colors"
            >
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-primary-200 pt-4 pb-4">
